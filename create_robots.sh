...
for filepath in `ls -1 | awk -F '.' '{print $1}' | fgrep -v index | uniq`; do
  ...
  echo "  <a href='"$path".lxf'><img src='http://cache.lego.com/r/ldd/-/media/digital%20designer/shared/bluebrick_graphic.png?l.r2=-1427989522'  width='30' height='30'> $path - LEGO Digital Designer</a><br>" >> $OUTPUT
